 ...
 * par ligne) dans  Documents/Cap CAVVA/data/.
...
const DEFAULT_OUT_DIR = path.join(os.homedir(), 'Documents', 'Cap CAVVA', 'data');
...
function runExtraction(opts = {}) {
  ...
  const APP_NAME = opts.appName || 'CapCAVVA-Extract';
