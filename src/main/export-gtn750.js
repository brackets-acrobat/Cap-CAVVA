...
//
// Cible : MSFS 2024 seulement — c'est déjà le simulateur dont Cap CAVVA extrait
// ses terrains et ses navaids (msfs-import.js).
//
// Le XML est construit côté renderer (features/export-gtn750.js), comme le
// .ccfp l'est par plan-io.js : ici on ne fait que poser le fichier.
// ============================================================
...
function cheminsUserCfg() {
  ...
  } catch (_) { /* getPath peut échouer avant que l'app soit prête */ }
