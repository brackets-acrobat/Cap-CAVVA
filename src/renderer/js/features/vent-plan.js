...
// colonne « Route ». C'est aussi le référentiel de MSFS (AMBIENT WIND
// DIRECTION) et celui d'un METAR écrit : le vent du simulateur tombe donc
// directement dans les cases, sans conversion. (L'indicateur de vent de la
// carte, lui, reste affiché en magnétique — c'est ce que l'ATIS annonce.)
//
