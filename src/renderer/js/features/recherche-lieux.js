...
// airports-data.js ne rend que les aérodromes dont le code commence par LF et
// les navaids situés en métropole — les bases MSFS sont mondiales, et chercher
// « TOURS » dedans ramènerait des terrains de quatre continents. Ce fichier ne
// filtre donc rien : il affiche ce qu'on lui donne.
//
...
async function lancerRecherche() {
  ...
  let res;
  try { res = await window.cap.rechercherLieux(q); } catch (e) { res = { ok: false, reason: 'error' }; }
