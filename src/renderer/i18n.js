...
const TRANSLATIONS = {
  fr: {
    ...
    layerPistes: 'Pistes',
    layerParkings: 'Parkings',
    layerVfrPoints: 'Points de report VFR',
    layerZoomNote: 'Ces couches apparaissent à partir du zoom 8, les pistes à partir du zoom 12, les parkings du zoom 15.',
    parkingsBaseAncienne: 'Les places de stationnement exigent un nouvel import des aérodromes MSFS.',
  ...
  en: {
    ...
    layerNavaids: 'Navaids',
    layerPistes: 'Runways',
    layerParkings: 'Parking',
    layerVfrPoints: 'VFR reporting points',
    layerZoomNote: 'These layers appear from zoom 8 onwards, runways from zoom 12, parking from zoom 15.',
    parkingsBaseAncienne: 'Parking spots require a fresh import of the MSFS airports.',
