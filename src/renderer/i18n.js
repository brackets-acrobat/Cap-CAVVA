...
const TRANSLATIONS = {
  fr: {
    ...
    gtnExportOk: 'Plan de vol déposé pour le GTN750. Dans le simulateur : page Flight Plan, menu, bouton Import.',
    gtnExportVide: 'Aucune route à exporter.',
    gtnExportSimIntrouvable: 'MSFS 2024 introuvable : le dossier Community n\'a pas pu être localisé.',
    gtnExportPaquetIntrouvable: 'Le GTN750 de PMS50 n\'a pas été trouvé dans le dossier Community de MSFS 2024.',
    ...
    ctxVac: 'Carte VAC (SIA)',
    vacRecherche: 'Carte VAC {code} : recherche au SIA…',
    ...
    alerteRadioClasse: 'Vous allez pénétrer dans la zone de classe {classe} ({nom}), contact radio obligatoire',
    alerteRadioType: 'Vous allez pénétrer dans la zone {type} ({nom}), contact radio obligatoire',
    alerteInterdite: 'Vous allez pénétrer dans la zone interdite ({nom})',
    alerteClasseA: 'Vous allez pénétrer dans la zone de classe A ({nom}), VFR interdit',
    alerteReglementee: 'Vous allez pénétrer dans la zone réglementée ({nom}), active pour la séance',
    ...
    espContour: 'Contour : {nom} — IGN BD TOPO, pas le SIA',
    espPonctuel: 'Étendue inconnue : le SIA n\'en donne qu\'un repère',
    ...
    espImportContours: '{n} parcs et réserves ont reçu leur contour de la BD TOPO (IGN) ; {k} zones restent des repères sans étendue.',
    espImportVfr: '{n} points de report VFR — couche « Points de report VFR », visible à partir du zoom 8.',
    ...
    navVentDirTitle: 'Direction d\'où vient le vent, en degrés VRAIS (comme MSFS et les METAR écrits). Verrouillée et rafraîchie toutes les 30 s tant que MSFS est connecté.',
    navVentKtTitle: 'Force du vent, en nœuds. Verrouillée et rafraîchie toutes les 30 s tant que MSFS est connecté.',
    navVentSimTitle: 'Vent lu dans le simulateur, rafraîchi toutes les 30 secondes. Les cases redeviennent saisissables à la déconnexion.',
  ...
  en: {
    ...
    gtnExportOk: 'Flight plan written for the GTN750. In the sim: Flight Plan page, menu, Import button.',
    gtnExportVide: 'No route to export.',
    gtnExportSimIntrouvable: 'MSFS 2024 not found: the Community folder could not be located.',
    gtnExportPaquetIntrouvable: 'The PMS50 GTN750 was not found in the MSFS 2024 Community folder.',
    ...
    ctxVac: 'VAC chart (SIA)',
    vacRecherche: 'VAC chart {code}: looking it up at the SIA…',
    ...
    alerteRadioClasse: 'You are about to enter class {classe} airspace ({nom}), radio contact mandatory',
    alerteRadioType: 'You are about to enter {type} airspace ({nom}), radio contact mandatory',
    alerteInterdite: 'You are about to enter prohibited airspace ({nom})',
    alerteClasseA: 'You are about to enter class A airspace ({nom}), VFR not permitted',
    alerteReglementee: 'You are about to enter restricted airspace ({nom}), active for the session',
    ...
    espContour: 'Outline: {nom} — IGN BD TOPO, not the SIA',
    espPonctuel: 'Extent unknown: the SIA only gives a reference point',
    ...
    espImportContours: '{n} parks and reserves got their outline from BD TOPO (IGN); {k} zones remain reference points with no extent.',
    espImportVfr: '{n} VFR reporting points — layer "VFR reporting points", visible from zoom 8 onwards.',
    ...
    navVentDirTitle: 'Direction the wind is coming FROM, in TRUE degrees (as MSFS and written METARs give it). Locked and refreshed every 30 s while MSFS is connected.',
    navVentKtTitle: 'Wind speed, in knots. Locked and refreshed every 30 s while MSFS is connected.',
    navVentSimTitle: 'Wind read from the simulator, refreshed every 30 seconds. The fields become editable again on disconnection.',
